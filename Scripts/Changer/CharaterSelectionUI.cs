...
//This class in unity is used as a character selection in the Game Menu 
public class CharaterSelectionUI : MonoBehaviour {
    ...
    private void Start() {
        ...
        {                                                                     /* The GameManager game setting will be used to select each Character.After selecting a Character as a button, 
                                                                                 * the result will be saved in the GameManager and use the main Prefab as a clone.*/
